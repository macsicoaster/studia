...
for ids, z in (select dziel.gid ids, grd.z_mean z from gran_dzielnice dziel inner join grd_200m grd
...
select dziel.gid ids, AVG(grd.z_mean) z from gran_dzielnice dziel inner join grd_200m grd
...
--6. Oblicz liczbę otworów hydrogeologicznych w siatce grd_200m
