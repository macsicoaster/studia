...
title(['newelm test data, mse: ', num2str(test_error),' function = tansig'])
...
siec = newelm([zakres; zakres],[liczba_n_h1 liczba_n_h2 liczba_n_o],{'purelin', ...
...
plot(ynn2,'g')
legend('target output','neural network output')
title(['newelm test data, mse: ', num2str(test_error),' function = purelin'])
...
siec = newelm([zakres; zakres],[liczba_n_h1 liczba_n_h2 liczba_n_o],{'logsig', ...
...
plot(ynn2,'g')
legend('target output','neural network output')
title(['newelm test data, mse: ', num2str(test_error),' function = logsig'])
...
siec = newelm([zakres; zakres],[liczba_n_h1 liczba_n_h2 liczba_n_o],{'radbas', ...
    'radbas', 'purelin'},'trainlm');
...
plot(ynn2,'g')
legend('target output','neural network output')
title(['newelm test data, mse: ', num2str(test_error),' function = radbas'])